#line 1 "/home/duarte/Arduino/lab_SCDTR_final_1st/func.cpp"
#include "main.hpp"
 ...
 */
float get_duty_cycle(float LUX) { return LUX * Gain_lux_to_pwm; }
...
float convert_to_ldr_r(float lux) { return (float)pow(10, B) * pow(lux, M); }
