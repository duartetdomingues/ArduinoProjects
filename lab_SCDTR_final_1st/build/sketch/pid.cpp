#line 1 "/home/duarte/Arduino/lab_SCDTR_final_1st/pid.cpp"
#include "main.hpp"
...
extern bool occupancy_state;
extern bool anti_windup_state;
extern bool feedback_state;
extern uint16_t external_illuminance;
...
void pid()
{
  ...
  {
    lux_error = (Kp * error + Ki * integral);
  }
