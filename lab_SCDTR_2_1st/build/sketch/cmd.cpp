#line 1 "/home/duarte/Arduino/lab_SCDTR_2_1st/cmd.cpp"
#include "main.hpp"
...
// Serial.println("RECV CMD");
    ...
    if (size = Serial.available())
    {
        ...
        {
            Serial.println("Waiting for more data from Serial");
        }
